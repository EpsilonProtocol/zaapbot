...
import { ACCESS_TOKEN, CONSUMER_KEY, CONSUMER_SECRET, TOKEN_SECRET } from '../config/env';
...
class TwitterService {
	...
	getUserDataFromId = async (userId: string) => {
		return await this.twitterClient.v2.user(userId);
	};
